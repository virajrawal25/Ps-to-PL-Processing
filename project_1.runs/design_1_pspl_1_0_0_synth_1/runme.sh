...
HD_PWD='F:/A_viraj_drive/AMtech/Sem 2/VLSI SYSTEM DESIGN/Project/useful/extra_projects/ps2pl/ps2pl.runs/design_1_pspl_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pspl_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pspl_1_0_0.tcl
